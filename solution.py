...
COST_W_UNDERPREDICT = 25.0  # f_hat < f
COST_W_NORMAL = 1.0  # f <= f_hat < 1.2 * f
COST_W_OVERPREDICT = 10.0  # 1.2 f <= f_hat
...
def main():
    ...
    marginal_likelihood = model.estimate_marginal_likelihood()
    print("Marginal Log Likelihood of the training data", marginal_likelihood)

    print('Evaluate on Validation Set')
    pred_val, mean_val, std_val = model.make_predictions(X_val)
